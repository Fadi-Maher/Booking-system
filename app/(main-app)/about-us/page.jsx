    ...
    <div>
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.sectionText}>
            Reserve-Mate offers a comprehensive booking solution for a variety
            of industries, including:
          </p>
          <ul className={styles.list}>
            <li className={styles.listItem}>
              <strong className={styles.highlight}>Hospitality</strong>: Easily
              book hotel rooms, resorts, and vacation rentals.
            </li>
            <li className={styles.listItem}>
              <strong className={styles.highlight}>Restaurants</strong>: Reserve
              tables at your favorite dining spots.
            </li>
            <li className={styles.listItem}>
              <strong className={styles.highlight}>Events</strong>: Secure
              tickets for concerts, conferences, and other events.
            </li>
            <li className={styles.listItem}>
              <strong className={styles.highlight}>Services</strong>: Schedule
              appointments for salons, spas, and other personal services.
            </li>
          </ul>
          <p className={styles.sectionText}>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li className={styles.listItem}>
              <strong className={styles.highlight}>Reliable</strong>: We
              prioritize reliability to ensure your bookings are secure and
              confirmed.
            </li>
            <li className={styles.listItem}>
              <strong className={styles.highlight}>24/7 Support</strong>: Our
              dedicated support team is available around the clock to assist you
