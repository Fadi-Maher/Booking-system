          ...
          <div className="row">
            <div className="col-lg-3 col-md-6">
              <div>
                <div
                  ...
                  style={{
                    backgroundImage: `url('/roomsGallery/room-b1.jpg')`,
            ...
            <div className="col-lg-3 col-md-6">
              <div>
                <div
                  className={styles.roomitem}
                  style={{
                    backgroundImage: `url('/roomsGallery/room-b2.jpg')`,
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                    backgroundPosition: "top center",
                  }}
            ...
            <div className="col-lg-3 col-md-6">
              <div>
                <div
                  className={styles.roomitem}
                  style={{
                    backgroundImage: `url('/roomsGallery/room-b3.jpg')`,
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                    backgroundPosition: "top center",
                  }}
            ...
            <div className="col-lg-3 col-md-6">
              <div
                className={styles.roomitem}
                style={{
                  backgroundImage: `url('/roomsGallery/room-b4.jpg')`,
                  backgroundRepeat: "no-repeat",
                  backgroundSize: "cover",
                  backgroundPosition: "top center",
                }}
