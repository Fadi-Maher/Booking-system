  ...
  return (
    ...
    <section className={styles.contactInfo}>
      ...
      <ul className={styles.contactInfoList}>
        <li className={styles.contactInfoItem}><strong className={styles.contactInfoLabel}>Email</strong>: olivermichel88@gmail.com</li>
        <li className={styles.contactInfoItem}><strong className={styles.contactInfoLabel}>Phone</strong>: +20 100 221 7494</li>
